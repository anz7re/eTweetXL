...
Unload CTRLBOX
M = MsgBox("Display Control Box+?", vbOKOnly, CtrlBox_INFO.AppName)
    If M = vbOK Then
...
xFile = InputBox("Enter a name for your project:", CtrlBox_INFO.AppName)

If xFile <> "" Then

CTRLBOX.Caption = CtrlBox_INFO.AppName & " - " & xFile
