...
If CTRLBOX.Width > 510 Then: Call CtrlBox_TOOLS.shTskBar: xArt = "<lib>xbas;wait(3s);$": Call lexKey(xArt): Unload CTRLBOX: Call CtrlBox_TOOLS.dfsWindow: CTRLBOX.Show: Exit Sub

Call CtrlBox_TOOLS.hdTskBar: xArt = "<lib>xbas;wait(3s);$": Call lexKey(xArt): Call CtrlBox_TOOLS.fxsWindow
