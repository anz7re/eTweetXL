Attribute VB_Name = "eTweetXL_MSG"
'/###################################\
'//Application Error & Help Messages \\
'///#################################\\\

Public Function AppMsg(ByVal xMsg As Byte, errLvl) As Byte
...
Call getWindow(xWin)
xWin.xlFlowStrip.ForeColor = vbRed
'//msg
MsgBox ("Syntax error"), vbExclamation, eTweetXL_INFO.AppName
Exit Function
...
xWin.xlFlowStrip.Font.Color = vbRed
'//msg
MsgBox ("File not found"), vbExclamation, eTweetXL_INFO.AppName
Exit Function

'/3/Blank box error (information missing)
ElseIf xMsg = 3 Then
'//msg
MsgBox ("Information missing"), vbExclamation, eTweetXL_INFO.AppName
Exit Function

'/4/Invalid character
ElseIf xMsg = 4 Then
'//msg
MsgBox ("Invalid character entered"), vbExclamation, eTweetXL_INFO.AppName
Exit Function

'/5/Information not found
ElseIf xMsg = 5 Then
'//msg
MsgBox ("Couldn't find information for this user..."), vbInformation, eTweetXL_INFO.AppName
Exit Function

'/6/Missing connection before saving link
ElseIf xMsg = 6 Then
'//msg
MsgBox ("Connect your posts before saving!"), vbInformation, eTweetXL_INFO.AppName
Exit Function

'/7/API information not found for user
ElseIf xMsg = 7 Then
'//msg
MsgBox ("API information not found for this user"), vbCritical, eTweetXL_INFO.AppName
Exit Function

'/8/Invalid runtime
ElseIf xMsg = 8 Then
'//msg
MsgBox ("Invalid runtime entered"), vbExclamation, eTweetXL_INFO.AppName
Exit Function

'/9/No user set during run
ElseIf xMsg = 9 Then
'//msg
MsgBox ("A User hasn't been set!"), vbInformation, eTweetXL_INFO.AppName
Exit Function

'/10/Break
ElseIf xMsg = 10 Then
'//msg
MsgBox ("Break complete"), vbInformation, eTweetXL_INFO.AppName
Exit Function

'/11/Linker empty
ElseIf xMsg = 11 Then
'//msg
MsgBox ("Linker Emptied"), vbInformation, eTweetXL_INFO.AppName
Exit Function

'/12/Video is too large
ElseIf xMsg = 12 Then
'//msg
MsgBox ("This video is too large for Twitter."), vbInformation, eTweetXL_INFO.AppName
Exit Function

'/13/Gif is too large
ElseIf xMsg = 13 Then
'//msg
MsgBox ("This gif is too large for Twitter."), vbInformation, eTweetXL_INFO.AppName
Exit Function

'/14/Hit Twitter gif/video limit
ElseIf xMsg = 14 Then
'//msg
MsgBox ("Twitter only allows one gif/video per post."), vbInformation, eTweetXL_INFO.AppName
Exit Function

'/15/Hit Twitter media limit
ElseIf xMsg = 15 Then
'//msg
MsgBox ("You've hit the media limit."), vbInformation, eTweetXL_INFO.AppName
Exit Function

'/16/Changes saved to post successfully
ElseIf xMsg = 16 Then
'//msg
MsgBox ("Changes saved"), vbInformation, eTweetXL_INFO.AppName
Exit Function

'/17/Missing Linker data
ElseIf xMsg = 17 Then
'//msg
MsgBox ("Something's missing from the linker!"), vbInformation, eTweetXL_INFO.AppName
Exit Function

'/18/Username field empty
ElseIf xMsg = 18 Then
'//msg
MsgBox ("Username field empty"), vbInformation, eTweetXL_INFO.AppName
Exit Function

'/19/Password field empty
ElseIf xMsg = 19 Then
'//msg
MsgBox ("Password field empty"), vbInformation, eTweetXL_INFO.AppName
Exit Function

'/20/Password field empty
ElseIf xMsg = 20 Then
'//msg
MsgBox ("Profile field empty"), vbInformation, eTweetXL_INFO.AppName
Exit Function

'/21/Information not found
ElseIf xMsg = 21 Then
'//msg
MsgBox ("Information not found"), vbExclamation, eTweetXL_INFO.AppName
Exit Function

'/22/Exiting edit mode
ElseIf xMsg = 22 Then
'//msg
MsgBox ("Exiting Edit Mode"), vbInformation, eTweetXL_INFO.AppName
Exit Function

'/23/Entering edit mode
ElseIf xMsg = 23 Then
'//msg
MsgBox ("Edit Mode Active"), vbInformation, eTweetXL_INFO.AppName
Exit Function

'/24/Too many characters
ElseIf xMsg = 24 Then
'//msg
MsgBox ("This post has too many characters!"), vbInformation, eTweetXL_INFO.AppName
Exit Function

'/25/App currently running
ElseIf xMsg = 25 Then
'//msg
MsgBox ("The application is currently running..."), vbExclamation, eTweetXL_INFO.AppName
Exit Function

'/26/App currently frozen
ElseIf xMsg = 26 Then
'//msg
MsgBox ("The application is currently frozen..."), vbExclamation, eTweetXL_INFO.AppName
Exit Function
...
& "If the problem persists you may need to break &/or restart the application."), vbExclamation, eTweetXL_INFO.AppName
Exit Function

'/28/Help settings couldn't be changed
ElseIf xMsg = 28 Then
'//msg
MsgBox ("There was an error changing the help settings."), vbExclamation, eTweetXL_INFO.AppName
Exit Function
End If
    End If

End Function
Public Function HoverHelp(ByVal xMsg As Byte) As Byte

On Error Resume Next

If Range("xlasSilent").Value2 <> 1 And Range("HelpStatus").Value2 <> 0 Then

'//check current hover position (exit if not @ same position to activate the help wizard)
If Range("HoverPos").Value <> xMsg Then Range("HoverStatus").Value2 = 0: Range("HoverPos").Value = xMsg: Exit Function

nl = vbNewLine

Range("HoverStatus").Value2 = Range("HoverStatus").Value2 + 1

If Range("HoverStatus").Value2 >= 20 Then
