...
'//Find running window
Call fndWindow(xWin)
If Range("xlasWinForm").Value2 > 10 Then
        ElseIf Range("xlasWinForm").Value2 = 10 Then Set xWin = CTRLBOX.CtrlBoxWindow
            Else
...
XLREPLACE.Hide: xArt = "<lib>xbas;wastetime(25);$": Call lexKey(xArt): XLREPLACE.Show
