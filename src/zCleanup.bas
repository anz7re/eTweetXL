...
'//Clean main data area (everything except latches & code)
...
'//Clean application Latch area (skip HelpStatus)
Range("AZ1:AZ18, AZ20:AZ" & lastR).ClearContents
