...
Workbooks(appEnv).Worksheets(appBlk).Range("xlasKeyCtrl").Value2 = vbKeyShift
Call lexKey(xArt)
Exit Sub
End If
...
Range("AZ5").name = "AppErrRef"
Range("AZ6").name = "AppState"
Range("AZ7").name = "AppStatus"
Range("AZ8").name = "ConnectStatus"
Range("AZ9").name = "ConnectTrig"
Range("AZ10").name = "DataPullTrig"
Range("AZ11").name = "DraftFilter"
Range("AZ12").name = "DraftTrig"
Range("AZ13").name = "DynOffsetTrig"
Range("AZ14").name = "EditStatus"
Range("AZ15").name = "GetInfo"
Range("AZ16").name = "GifCntr"
Range("AZ17").name = "HelpStatus"
Range("AZ18").name = "HoverPos"
Range("AZ19").name = "HoverStatus"
Range("AZ20").name = "LinkerCount"
Range("AZ21").name = "LinkerIndex"
Range("AZ22").name = "LinkerTotal"
Range("AZ23").name = "LinkTrig"
Range("AZ24").name = "LoadLess"
Range("AZ25").name = "MedScrollLink"
Range("AZ26").name = "MedScrollPos"
Range("AZ27").name = "PassQuit"
Range("AZ28").name = "RemLink"
Range("AZ29").name = "RtChange"
Range("AZ30").name = "RtCntr"
Range("AZ31").name = "RtState"
Range("AZ32").name = "SendAPI"
Range("AZ33").name = "ThreadScrollPos"
Range("AZ34").name = "ThreadStatus"
Range("AZ35").name = "TimeTrig"
Range("AZ36").name = "UserTrig"
Range("AZ37").name = "VidCntr"
