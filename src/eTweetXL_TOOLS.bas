...
ETWEETXLPOST_EXT.ExitBtn.Font.Underline = False
End If
...
'//Exit...
If xBtn = 14 Then
ETWEETXLPOST_EXT.ExitBtn.Font.Underline = True
ETWEETXLPOST_EX.AppendBtn.Font.Underline = False
ETWEETXLPOST_EX.LoadPostBtn.Font.Underline = False
ETWEETXLPOST_EX.ReflectBtn.Font.Underline = False
ETWEETXLPOST_EX.AddSizeHBtn.Font.Underline = False
...
Range("AZ5").name = "AppendTrig"
Range("AZ6").name = "AppErrRef"
Range("AZ7").name = "AppState"
Range("AZ8").name = "AppStatus"
Range("AZ9").name = "ConnectStatus"
Range("AZ10").name = "ConnectTrig"
Range("AZ11").name = "DataPullTrig"
Range("AZ12").name = "DraftFilter"
Range("AZ13").name = "DraftTrig"
Range("AZ14").name = "DynOffsetTrig"
Range("AZ15").name = "EditStatus"
Range("AZ16").name = "GetInfo"
Range("AZ17").name = "GifCntr"
Range("AZ18").name = "HelpStatus"
Range("AZ19").name = "HoverPos"
Range("AZ20").name = "HoverStatus"
Range("AZ21").name = "LinkerCount"
Range("AZ22").name = "LinkerIndex"
Range("AZ23").name = "LinkerTotal"
Range("AZ24").name = "LinkTrig"
Range("AZ25").name = "LoadLess"
Range("AZ26").name = "MedScrollLink"
Range("AZ27").name = "MedScrollPos"
Range("AZ28").name = "PassQuit"
Range("AZ29").name = "ReflectTrig"
Range("AZ30").name = "RemLink"
Range("AZ31").name = "RtChange"
Range("AZ32").name = "RtCntr"
Range("AZ33").name = "RtState"
Range("AZ34").name = "SendAPI"
Range("AZ35").name = "ThreadScrollPos"
Range("AZ36").name = "ThreadStatus"
Range("AZ37").name = "TimeTrig"
Range("AZ38").name = "UserTrig"
Range("AZ39").name = "VidCntr"
