...
Workbooks(appEnv).Worksheets(appBlk).Range("xlasKeyCtrl").Value2 = 17
Exit Sub
End If
  
'//Shift
If xKey = vbKeyShift Then
Workbooks(appEnv).Worksheets(appBlk).Range("xlasKeyCtrl").Value2 = 16
Call xlas(Art)
Exit Sub
End If
...
ETWEETXLHOME.ProgRatio.Caption = LLCntr - 1 & "/" & LLTotal
...
'//underline post box extension

On Error Resume Next

'//Append...
If xBtn = 1 Then
ETWEETXLPOST_EX.AppendBtn.Font.Underline = True
ETWEETXLPOST_EX.LoadPostBtn.Font.Underline = False
ETWEETXLPOST_EX.ReflectBtn.Font.Underline = False
ETWEETXLPOST_EX.AddSizeHBtn.Font.Underline = False
ETWEETXLPOST_EX.RmvSizeHBtn.Font.Underline = False
ETWEETXLPOST_EX.AddSizeVBtn.Font.Underline = False
ETWEETXLPOST_EX.RmvSizeVBtn.Font.Underline = False
ETWEETXLPOST_EX.SplitPostBtn.Font.Underline = False
ETWEETXLPOST_EX.TrimPostBtn.Font.Underline = False
ETWEETXLPOST_EX.AddThreadBtn.Font.Underline = False
ETWEETXLPOST_EX.RmvThreadBtn.Font.Underline = False
ETWEETXLPOST_EX.RmvAllThreadBtn.Font.Underline = False
ETWEETXLPOST_EX.SavePostBtn.Font.Underline = False
ETWEETXLPOST_EX.ExitBtn.Font.Underline = False
End If

'//Load...
If xBtn = 2 Then
ETWEETXLPOST_EX.LoadPostBtn.Font.Underline = True
ETWEETXLPOST_EX.AppendBtn.Font.Underline = False
ETWEETXLPOST_EX.ReflectBtn.Font.Underline = False
ETWEETXLPOST_EX.AddSizeHBtn.Font.Underline = False
ETWEETXLPOST_EX.RmvSizeHBtn.Font.Underline = False
ETWEETXLPOST_EX.AddSizeVBtn.Font.Underline = False
...
'//Reflect...
If xBtn = 3 Then
ETWEETXLPOST_EX.ReflectBtn.Font.Underline = True
ETWEETXLPOST_EX.AppendBtn.Font.Underline = False
ETWEETXLPOST_EX.LoadPostBtn.Font.Underline = False
ETWEETXLPOST_EX.AddSizeHBtn.Font.Underline = False
ETWEETXLPOST_EX.RmvSizeHBtn.Font.Underline = False
...
'//+ Size Horizontal...
If xBtn = 4 Then
ETWEETXLPOST_EX.AddSizeHBtn.Font.Underline = True
ETWEETXLPOST_EX.AppendBtn.Font.Underline = False
ETWEETXLPOST_EX.LoadPostBtn.Font.Underline = False
ETWEETXLPOST_EX.ReflectBtn.Font.Underline = False
ETWEETXLPOST_EX.RmvSizeHBtn.Font.Underline = False
...
'//- Size Horizontal...
If xBtn = 5 Then
ETWEETXLPOST_EX.RmvSizeHBtn.Font.Underline = True
ETWEETXLPOST_EX.AppendBtn.Font.Underline = False
ETWEETXLPOST_EX.LoadPostBtn.Font.Underline = False
ETWEETXLPOST_EX.ReflectBtn.Font.Underline = False
ETWEETXLPOST_EX.AddSizeHBtn.Font.Underline = False
...
'//+ Size Vertical...
If xBtn = 6 Then
ETWEETXLPOST_EX.AddSizeVBtn.Font.Underline = True
ETWEETXLPOST_EX.AppendBtn.Font.Underline = False
ETWEETXLPOST_EX.LoadPostBtn.Font.Underline = False
ETWEETXLPOST_EX.ReflectBtn.Font.Underline = False
ETWEETXLPOST_EX.AddSizeHBtn.Font.Underline = False
...
'//- Size Vertical...
If xBtn = 7 Then
ETWEETXLPOST_EX.RmvSizeVBtn.Font.Underline = True
ETWEETXLPOST_EX.AppendBtn.Font.Underline = False
ETWEETXLPOST_EX.LoadPostBtn.Font.Underline = False
ETWEETXLPOST_EX.ReflectBtn.Font.Underline = False
ETWEETXLPOST_EX.AddSizeHBtn.Font.Underline = False
...
'//Split Post...
If xBtn = 8 Then
ETWEETXLPOST_EX.SplitPostBtn.Font.Underline = True
ETWEETXLPOST_EX.AppendBtn.Font.Underline = False
ETWEETXLPOST_EX.LoadPostBtn.Font.Underline = False
ETWEETXLPOST_EX.ReflectBtn.Font.Underline = False
ETWEETXLPOST_EX.AddSizeHBtn.Font.Underline = False
...
'//Trim Post...
If xBtn = 9 Then
ETWEETXLPOST_EX.TrimPostBtn.Font.Underline = True
ETWEETXLPOST_EX.AppendBtn.Font.Underline = False
ETWEETXLPOST_EX.LoadPostBtn.Font.Underline = False
ETWEETXLPOST_EX.ReflectBtn.Font.Underline = False
ETWEETXLPOST_EX.AddSizeHBtn.Font.Underline = False
...
'//+ Thread...
If xBtn = 10 Then
ETWEETXLPOST_EX.AddThreadBtn.Font.Underline = True
ETWEETXLPOST_EX.AppendBtn.Font.Underline = False
ETWEETXLPOST_EX.LoadPostBtn.Font.Underline = False
ETWEETXLPOST_EX.ReflectBtn.Font.Underline = False
ETWEETXLPOST_EX.AddSizeHBtn.Font.Underline = False
...
'//- Thread...
If xBtn = 11 Then
ETWEETXLPOST_EX.RmvThreadBtn.Font.Underline = True
ETWEETXLPOST_EX.AppendBtn.Font.Underline = False
ETWEETXLPOST_EX.LoadPostBtn.Font.Underline = False
ETWEETXLPOST_EX.ReflectBtn.Font.Underline = False
ETWEETXLPOST_EX.AddSizeHBtn.Font.Underline = False
...
'//-* Thread...
If xBtn = 12 Then
ETWEETXLPOST_EX.RmvAllThreadBtn.Font.Underline = True
ETWEETXLPOST_EX.AppendBtn.Font.Underline = False
ETWEETXLPOST_EX.LoadPostBtn.Font.Underline = False
ETWEETXLPOST_EX.ReflectBtn.Font.Underline = False
ETWEETXLPOST_EX.AddSizeHBtn.Font.Underline = False
...
'//Save Post...
If xBtn = 13 Then
ETWEETXLPOST_EX.SavePostBtn.Font.Underline = True
ETWEETXLPOST_EX.AppendBtn.Font.Underline = False
ETWEETXLPOST_EX.LoadPostBtn.Font.Underline = False
ETWEETXLPOST_EX.ReflectBtn.Font.Underline = False
ETWEETXLPOST_EX.AddSizeHBtn.Font.Underline = False
...
'//Exit...
If xBtn = 14 Then
ETWEETXLPOST_EX.ExitBtn.Font.Underline = True
ETWEETXLPOST_EX.AppendBtn.Font.Underline = False
ETWEETXLPOST_EX.LoadPostBtn.Font.Underline = False
ETWEETXLPOST_EX.ReflectBtn.Font.Underline = False
ETWEETXLPOST_EX.AddSizeHBtn.Font.Underline = False
...
End Sub
Public Function hostSelection(ByVal xType As Long, ByVal xPos As Long)

Call getWindow(xWin)

If xType = 1 Then
MsgBox (Replace(xWin.UserBox.List(xPos), "(" & xPos + 1 & ")", vbNullString)), vbOKOnly, eTweetXL_INFO.AppName
ElseIf xType = 2 Then
MsgBox (Replace(xWin.LinkerBox.List(xPos), "(" & xPos + 1 & ")", vbNullString)), vbOKOnly, eTweetXL_INFO.AppName
ElseIf xType = 3 Then
MsgBox (Replace(xWin.RuntimeBox.List(xPos), "(" & xPos + 1 & ")", vbNullString)), vbOKOnly, eTweetXL_INFO.AppName
End If

End Function
Public Function connectApp()

'//Label application memory addresses

Range("AZ1").name = "ActiveOffset"
Range("AZ2").name = "ActiveTarget"
Range("AZ3").name = "ActiveTweet"
Range("AZ4").name = "ActiveUser"
Range("AZ5").name = "AlignTrig"
Range("AZ6").name = "AppendTrig"
Range("AZ7").name = "AppErrRef"
Range("AZ8").name = "AppState"
Range("AZ9").name = "AppStatus"
Range("AZ10").name = "ConnectStatus"
Range("AZ11").name = "ConnectTrig"
Range("AZ12").name = "DataPullTrig"
Range("AZ13").name = "DraftFilter"
Range("AZ14").name = "DraftTrig"
Range("AZ15").name = "DynOffsetTrig"
Range("AZ16").name = "EditStatus"
Range("AZ17").name = "GetInfo"
Range("AZ18").name = "GifCntr"
Range("AZ19").name = "HelpStatus"
Range("AZ20").name = "HoverPos"
Range("AZ21").name = "HoverStatus"
Range("AZ22").name = "LinkerCount"
Range("AZ23").name = "LinkerIndex"
Range("AZ24").name = "LinkerTotal"
Range("AZ25").name = "LinkTrig"
Range("AZ26").name = "LoadLess"
Range("AZ27").name = "MedScrollLink"
Range("AZ28").name = "MedScrollPos"
Range("AZ29").name = "PassQuit"
Range("AZ30").name = "ReflectTrig"
Range("AZ31").name = "RemLink"
Range("AZ32").name = "RtChange"
Range("AZ33").name = "RtCntr"
Range("AZ34").name = "RtState"
Range("AZ35").name = "SendAPI"
Range("AZ36").name = "ThreadScrollPos"
Range("AZ37").name = "ThreadStatus"
Range("AZ38").name = "TimeTrig"
Range("AZ39").name = "UserTrig"
Range("AZ40").name = "VidCntr"

End Function
Public Function disconnectApp()

'//Remove application memory addresses

ActiveWorkbook.Names("ActiveOffset").Delete
ActiveWorkbook.Names("ActiveTarget").Delete
ActiveWorkbook.Names("ActiveTweet").Delete
ActiveWorkbook.Names("ActiveUser").Delete
ActiveWorkbook.Names("AlignTrig").Delete
ActiveWorkbook.Names("AppendTrig").Delete
ActiveWorkbook.Names("AppErrRef").Delete
ActiveWorkbook.Names("AppState").Delete
ActiveWorkbook.Names("AppStatus").Delete
ActiveWorkbook.Names("ConnectStatus").Delete
ActiveWorkbook.Names("ConnectTrig").Delete
ActiveWorkbook.Names("DataPullTrig").Delete
ActiveWorkbook.Names("DraftFilter").Delete
ActiveWorkbook.Names("DraftTrig").Delete
ActiveWorkbook.Names("DynOffsetTrig").Delete
ActiveWorkbook.Names("EditStatus").Delete
ActiveWorkbook.Names("GetInfo").Delete
ActiveWorkbook.Names("GifCntr").Delete
ActiveWorkbook.Names("HelpStatus").Delete
ActiveWorkbook.Names("HoverPos").Delete
ActiveWorkbook.Names("HoverStatus").Delete
ActiveWorkbook.Names("LinkerCount").Delete
ActiveWorkbook.Names("LinkerIndex").Delete
ActiveWorkbook.Names("LinkerTotal").Delete
ActiveWorkbook.Names("LinkTrig").Delete
ActiveWorkbook.Names("LoadLess").Delete
ActiveWorkbook.Names("MedScrollLink").Delete
ActiveWorkbook.Names("MedScrollPos").Delete
ActiveWorkbook.Names("PassQuit").Delete
ActiveWorkbook.Names("ReflectTrig").Delete
ActiveWorkbook.Names("RemLink").Delete
ActiveWorkbook.Names("RtChange").Delete
ActiveWorkbook.Names("RtCntr").Delete
ActiveWorkbook.Names("RtState").Delete
ActiveWorkbook.Names("SendAPI").Delete
ActiveWorkbook.Names("ThreadScrollPos").Delete
ActiveWorkbook.Names("ThreadStatus").Delete
ActiveWorkbook.Names("TimeTrig").Delete
ActiveWorkbook.Names("UserTrig").Delete
ActiveWorkbook.Names("VidCntr").Delete
