...
'//clear post boxes...
If Range("xlasWinForm").Value2 = 2 Or Range("xlasWinForm").Value2 = 3 Or Range("xlasWinForm").Value2 = 5 Then
...
If Range("xlasWinForm").Value2 = 2 Or 3 Or 5 Then
...
If Range("xlasWinForm").Value2 = 2 Then Set oForm = ETWEETXLSETUP
If Range("xlasWinForm").Value2 = 3 Then Set oForm = ETWEETXLPOST
...
If Range("xlasWinForm").Value2 = 3 Then Set oForm = ETWEETXLPOST
If Range("xlasWinForm").Value2 = 4 Then Set oForm = ETWEETXLQUEUE
