Attribute VB_Name = "eTweetXL_LOC"
'/####################################\
...
persFile = AppLoc & "\presets\" & ActiveProfile & "\pers\"

End Function
'//API pers file
Function xApiFile(apiFile) As String

apiFile = AppLoc & "\presets\" & ActiveProfile & "\pers\api.pers"
...
twtFile = AppLoc & "\presets\" & ActiveProfile & "\twt\"
    Else
...
If ETWEETXLPOST.ProfileListBox.Value = "" Then
thrFile = AppLoc & "\presets\" & ActiveProfile & "\thr\"
    Else
