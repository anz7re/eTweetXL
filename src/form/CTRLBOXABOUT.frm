...
'//start w/ msedge
xArt = "<lib>xbas;sh(msedge.exe " & "twitter.com/" & xLink & ");$" '//xlas
Call lexKey(xArt)

'//start w/ firefox
'xArt = "<lib>xbas;sh(firefox.exe " & "twitter.com/" & xLink & ");$" '//xlas
'Call lexKey(xArt)
...
'//start w/ msedge
xArt = "<lib>xbas;sh(msedge.exe " & WebsiteLink.Caption & ");$" '//xlas
Call lexKey(xArt)

'//start w/ firefox
'xArt = "<lib>xbas;sh(firefox.exe " & WebsiteLink.Caption & ");$" '//xlas
'Call lexKey(xArt)
