...
Range("Profile").Value = ETWEETXLAPISETUP.ProfileListBox.Value
Range("DataPullTrig").Value = 0
...
App_CLICK.SaveBtn_Clk

End Sub

Private Sub UserListBox_Click()

Call App_IMPORT.MyAPIData
