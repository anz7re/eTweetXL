...
End Sub
Private Sub SaveQueueBtn_Click()
...
If Range("xlasKeyCtrl").Value2 = 17 Then
Range("xlasWinForm").Value2 = 141
XLFONTBOX.Show
Range("xlasWinForm").Value2 = 14
Range("xlasKeyCtrl").Value2 = vbNullString
KeyCode.Value = 0
Exit Sub
End If
...
If Range("xlasKeyCtrl").Value2 = 17 Then
Range("xlasWinForm").Value2 = 141
Range("xlasWinFormLast").Value2 = 14
XLREPLACE.Show
Range("xlasKeyCtrl").Value2 = vbNullString
KeyCode.Value = 0
Exit Sub
...
If Range("DataPullTrig").Value2 <> 1 Then xNum = QueueBox.ListIndex: _
ETWEETXLPOST.ProfileListBox.Value = Range("ProfileLink").Offset(xNum + 1, 0).Value
...
If QueueBox.Value <> vbNullString Then MsgBox (QueueBox.Value), vbQuestion, eTweetXL_INFO.AppName
...
Call eTweetXL_CLICK.ViewMedBtn_Clk
