...
Art = "<lib>xtwt;winform(12);mk.user( -list" & UsernameBox.Value & ");$" '//xlas
Call xlas(Art)
Exit Sub
End If
...
If InStr(1, UsernameBox.Value, ",") Then
Art = "<lib>xtwt;winform(12);del.user( -list" & UsernameBox.Value & ");$" '//xlas
Call xlas(Art)
Exit Sub
End If
...
Art = "<lib>xtwt;winform(12);mk.profile( -list" & ProfileNameBox.Value & ");$" '//xlas
Call xlas(Art)
Exit Sub
End If
...
If InStr(1, ProfileNameBox.Value, ",") Then
Art = "<lib>xtwt;winform(12);del.profile( -list" & ProfileNameBox.Value & ");$" '//xlas
Call xlas(Art)
Exit Sub
End If
