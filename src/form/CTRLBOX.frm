...
WindowSel.Clear: xArt = "<lib>xbas;delayevent(10);$": Call lexKey(xArt): xType = 0: Call addOptions(xType)
Exit Sub
End If
...
Call Ctrlbox_CLICK.Maximize_Clk
WindowSel.Clear: xArt = "<lib>xbas;delayevent(10);$": Call lexKey(xArt): xType = 1: Call addOptions(xType)
Workbooks(appEnv).Worksheets(appBlk).Range("xlasKeyCtrl").Value2 = vbNullString
KeyCode.Value = 0
Exit Sub
End If
...
Call Ctrlbox_CLICK.NewFile_Clk
FileSel.Clear: xArt = "<lib>xbas;delayevent(10);$": Call lexKey(xArt): Call addOptions(xType)
Exit Sub
End If
...
Call Ctrlbox_CLICK.ClearScreen_Clk
EditSel.Clear: xArt = "<lib>xbas;delayevent(10);$": Call lexKey(xArt): Call addOptions(xType)
Exit Sub
End If
...
'DebugSel.Clear: xArt = "<lib>xbas;delayevent(10);$": Call lexKey(xArt): Call addOptions(xType)
'End If
'
''//Change font/background settings
...
XLFONTBOX.Show
OptionsSel.Clear: xArt = "<lib>xbas;delayevent(10);$": Call lexKey(xArt): Call addOptions(xType)
End If
...
RunSel.Clear: xArt = "<lib>xbas;delayevent(10);$": Call lexKey(xArt): Call addOptions(xType)
...
Call Ctrlbox_CLICK.Hide_Clk
WindowSel.Clear: xArt = "<lib>xbas;delayevent(10);$": Call lexKey(xArt): Call addOptions(xType)
Exit Sub
End If
...
CTRLBOXABOUT.Show
HelpSel.Clear: xArt = "<lib>xbas;delayevent(10);$": Call lexKey(xArt): Call addOptions(xType)
Exit Sub
End If
