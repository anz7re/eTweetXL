...
'//WinForm #
Workbooks(appEnv).Worksheets(appBlk).Range("xlasWinForm").Value2 = 10
...
'//WinForm #
Workbooks(appEnv).Worksheets(appBlk).Range("xlasWinForm").Value2 = 11
...
Call Ctrlbox_CLICK.NewFile_Clk
FileSel.Clear: xArt = "<lib>xbas;wastetime(10);$": Call lexKey(xArt): Call addOptions
Exit Sub
End If
...
Call Ctrlbox_CLICK.ClearScreen_Clk
EditSel.Clear: xArt = "<lib>xbas;wastetime(10);$": Call lexKey(xArt): Call addOptions
Exit Sub
End If
...
'DebugSel.Clear: xArt = "<lib>xbas;wastetime(10);$": Call lexKey(xArt): Call addOptions
'End If
'
''//Change font/background settings
...
XLFONTBOX.Show
OptionsSel.Clear: xArt = "<lib>xbas;wastetime(10);$": Call lexKey(xArt): Call addOptions
End If
...
Call lexKey(xArt)
    End If
    RunSel.Clear: xArt = "<lib>xbas;wastetime(10);$": Call lexKey(xArt): Call addOptions
        End If
...
Call Ctrlbox_CLICK.Hide_Clk
WindowSel.Clear: xArt = "<lib>xbas;wastetime(10);$": Call lexKey(xArt): Call addOptions
Exit Sub
End If
...
CTRLBOXABOUT.Show
HelpSel.Clear: xArt = "<lib>xbas;wastetime(10);$": Call lexKey(xArt): Call addOptions
Exit Sub
End If
...
Workbooks(appEnv).Worksheets(appBlk).Range("xlasWinForm").Value2 = Workbooks(appEnv).Worksheets(appBlk).Range("xlasWinFormLast").Value2
