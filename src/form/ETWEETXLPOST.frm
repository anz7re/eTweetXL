...
'//Reset triggers
Range("UserTrig").Value = 0: SwapUser.ForeColor = vbBlack: AddUserA.ForeColor = &H8000000B: AddUserB.ForeColor = &H8000000B
Range("DraftTrig").Value = 0: SwapDraft.ForeColor = vbBlack: AddDraftA.ForeColor = &H8000000B: AddDraftB.ForeColor = &H8000000B
Range("TimeTrig").Value = 0: SwapTime.ForeColor = vbBlack: AddTimeA.ForeColor = &H8000000B: AddTimeB.ForeColor = &H8000000B
...
Range("LinkerIndex").Value = LinkerBox.ListIndex
End If
...
Range("LinkerIndex").Value = RuntimeBox.ListIndex
End If
...
RuntimeBox.Selected(LinkerBox.ListIndex) = True
Range("LinkerIndex").Value = UserBox.ListIndex
End If
