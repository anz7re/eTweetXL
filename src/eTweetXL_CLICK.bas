...
If xPos > 0 Or EDITMODE <> 0 Then
    ...
    Exit Function
                        ...
                        End If
                            ...
                            xDraft = xDraft & " " & ETWEETXLPOST.DraftBox.Value & " [" & ETWEETXLPOST.DraftFilterBtn.Caption & "]"
                            If Left(xDraft, 1) = " " Then xDraft = Right(xDraft, Len(xDraft) - 1) '//remove leading space
...
'//Enter name for file
fiName = InputBox("Enter a name for your link:", eTweetXL_INFO.AppName)
